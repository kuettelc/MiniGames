from shapes import Rectangle, Circle, Padel, Ball, Wall, ScoreBoard, Padel2D
...
class Pong2D(GamesProtocol):
    def __init__(self, screen: pygame.Surface):
        ...
        self.padel_1 = Padel2D(Rectangle(0,self.PADEL_START,self.PADEL_W,self.PADEL_H), pygame.K_UP, pygame.K_DOWN, pygame.K_RIGHT, pygame.K_LEFT, pygame.key)
        self.padel_2 = Padel2D(Rectangle(self.SCREEN_W - self.PADEL_W, self.PADEL_START,self.PADEL_W, self.PADEL_H),pygame.K_w, pygame.K_s, pygame.K_d, pygame.K_a, pygame.key)
